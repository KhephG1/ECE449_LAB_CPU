...
#
# Script generated by Vivado on Sun Mar 08 11:09:11 -0700 2026
...
#
# Usage        : CPU_ROM.sh
#                CPU_ROM.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                CPU_ROM.sh [-reset_run]
#                CPU_ROM.sh [-reset_log]
#                CPU_ROM.sh [-help]
#
...
# script info
echo -e "CPU_ROM.sh - Script generated by export_simulation (Vivado v2025.1 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./CPU_ROM.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L xil_defaultlib -L blk_mem_gen_v8_4_11 -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot CPU_ROM xil_defaultlib.CPU_ROM xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim CPU_ROM -key {Behavioral:sim_1:Functional:CPU_ROM} -tclbatch cmd.tcl -log simulate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb CPU_ROM.wdb xsim.dir libdpi.so)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./CPU_ROM.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: CPU_ROM.sh [-help]\n\
Usage: CPU_ROM.sh [-step]\n\
Usage: CPU_ROM.sh [-lib_map_path]\n\
Usage: CPU_ROM.sh [-reset_run]\n\
Usage: CPU_ROM.sh [-reset_log]\n\
Usage: CPU_ROM.sh [-keep_index]\n\
Usage: CPU_ROM.sh [-noclean_files]\n\n\
