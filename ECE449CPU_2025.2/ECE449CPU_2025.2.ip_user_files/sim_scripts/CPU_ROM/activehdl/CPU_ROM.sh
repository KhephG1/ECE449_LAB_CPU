...
#                script (type 'CPU_ROM.sh -help' for more information).
#
...
map_setup_file()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="C:/Users/Kheph/Documents/Projects/School/ECE449CPU/ECE449_LAB_CPU/ECE449CPU_2025.2/ECE449CPU_2025.2.cache/compile_simlib/activehdl"
  fi
  if [[ ($lib_map_path != "") ]]; then
